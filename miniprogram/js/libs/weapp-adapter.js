...
/***/ (function(module, exports, __webpack_require__) {
    ...
    let _window2 = __webpack_require__(1);

    let _window = _interopRequireWildcard(_window2);
    ...
    function inject() {
	  ...
	  if (typeof __devtoolssubcontext === 'undefined' && platform === 'devtools') {
	    ...
	    for (let _key in _window.document) {
	      let _descriptor = Object.getOwnPropertyDescriptor(global.document, _key);
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let _WindowProperties = __webpack_require__(2);
    ...
    let _constructor = __webpack_require__(3);
    ...
    let _Canvas = __webpack_require__(9);

    let _Canvas2 = _interopRequireDefault(_Canvas);

    let _document2 = __webpack_require__(10);

    let _document3 = _interopRequireDefault(_document2);

    let _navigator2 = __webpack_require__(17);

    let _navigator3 = _interopRequireDefault(_navigator2);

    let _XMLHttpRequest2 = __webpack_require__(18);

    let _XMLHttpRequest3 = _interopRequireDefault(_XMLHttpRequest2);

    let _WebSocket2 = __webpack_require__(19);

    let _WebSocket3 = _interopRequireDefault(_WebSocket2);

    let _Image2 = __webpack_require__(11);

    let _Image3 = _interopRequireDefault(_Image2);

    let _Audio2 = __webpack_require__(12);

    let _Audio3 = _interopRequireDefault(_Audio2);

    let _FileReader2 = __webpack_require__(20);

    let _FileReader3 = _interopRequireDefault(_FileReader2);

    let _HTMLElement2 = __webpack_require__(4);

    let _HTMLElement3 = _interopRequireDefault(_HTMLElement2);

    let _localStorage2 = __webpack_require__(21);

    let _localStorage3 = _interopRequireDefault(_localStorage2);

    let _location2 = __webpack_require__(22);

    let _location3 = _interopRequireDefault(_location2);
    ...
    // 暴露全局的 canvas
    let canvas = new _Canvas2.default();
  ...
  /***/ (function(module, exports) {
    ...
    let innerWidth = exports.innerWidth = screenWidth;
    let innerHeight = exports.innerHeight = screenHeight;
    ...
    let ontouchstart = exports.ontouchstart = null;
    let ontouchmove = exports.ontouchmove = null;
    let ontouchend = exports.ontouchend = null;
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let _HTMLElement3 = __webpack_require__(4);

    let _HTMLElement4 = _interopRequireDefault(_HTMLElement3);
    ...
    let HTMLImageElement = exports.HTMLImageElement = function (_HTMLElement) {
    ...
    let HTMLCanvasElement = exports.HTMLCanvasElement = function (_HTMLElement2) {
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let _Element2 = __webpack_require__(5);

    let _Element3 = _interopRequireDefault(_Element2);

    let _util = __webpack_require__(8);
    ...
    let HTMLElement = function (_Element) {
	  ...
	  function HTMLElement() {
	    let tagName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

	    _classCallCheck(this, HTMLElement);

	    let _this = _possibleConstructorReturn(this, (HTMLElement.__proto__ || Object.getPrototypeOf(HTMLElement)).call(this));
	  ...
	  _createClass(HTMLElement, [{
	    ...
	    key: 'clientWidth',
	    get: function get() {
	      let ret = parseInt(this.style.fontSize, 10) * this.innerHTML.length;
	    ...
	    key: 'clientHeight',
	    get: function get() {
	      let ret = parseInt(this.style.fontSize, 10);
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let _Node2 = __webpack_require__(6);

    let _Node3 = _interopRequireDefault(_Node2);
    ...
    let ELement = function (_Node) {
	  _inherits(ELement, _Node);

	  function ELement() {
	    _classCallCheck(this, ELement);

	    let _this = _possibleConstructorReturn(this, (ELement.__proto__ || Object.getPrototypeOf(ELement)).call(this));
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let _EventTarget2 = __webpack_require__(7);

    let _EventTarget3 = _interopRequireDefault(_EventTarget2);
    ...
    let Node = function (_EventTarget) {
	  _inherits(Node, _EventTarget);

	  function Node() {
	    _classCallCheck(this, Node);

	    let _this = _possibleConstructorReturn(this, (Node.__proto__ || Object.getPrototypeOf(Node)).call(this));
	  ...
	  _createClass(Node, [{
	    ...
	    value: function cloneNode() {
	      let copyNode = Object.create(this);
	    ...
	    value: function removeChild(node) {
	      let index = this.childNodes.findIndex(function (child) {
	        return child === node;
	      });
    ...
    let EventTarget = function () {
	  ...
	  _createClass(EventTarget, [{
	    ...
	    value: function dispatchEvent() {
	      ...
	      let listeners = _events.get(this)[event.type];
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let _HTMLElement = __webpack_require__(4);

    let _HTMLElement2 = _interopRequireDefault(_HTMLElement);

    let _document = __webpack_require__(10);

    let _document2 = _interopRequireDefault(_document);
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let _window = __webpack_require__(1);

    let window = _interopRequireWildcard(_window);

    let _HTMLElement = __webpack_require__(4);

    let _HTMLElement2 = _interopRequireDefault(_HTMLElement);

    let _Image = __webpack_require__(11);

    let _Image2 = _interopRequireDefault(_Image);

    let _Audio = __webpack_require__(12);

    let _Audio2 = _interopRequireDefault(_Audio);
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let _HTMLAudioElement2 = __webpack_require__(13);

    let _HTMLAudioElement3 = _interopRequireDefault(_HTMLAudioElement2);
    ...
    let _innerAudioContext = new WeakMap();
    let _src = new WeakMap();
    let _loop = new WeakMap();
    let _autoplay = new WeakMap();

    let Audio = function (_HTMLAudioElement) {
	  _inherits(Audio, _HTMLAudioElement);

	  function Audio(url) {
	    _classCallCheck(this, Audio);

	    let _this = _possibleConstructorReturn(this, (Audio.__proto__ || Object.getPrototypeOf(Audio)).call(this));
	  ...
	  _createClass(Audio, [{
	    ...
	    value: function canPlayType() {
	      let mediaType = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let _HTMLMediaElement2 = __webpack_require__(14);

    let _HTMLMediaElement3 = _interopRequireDefault(_HTMLMediaElement2);
    ...
    let HTMLAudioElement = function (_HTMLMediaElement) {
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let HTMLMediaElement = function (_HTMLElement) {
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    let TouchEvent = function TouchEvent(type) {
    ...
    let XMLHttpRequest = function () {
	  ...
	  _createClass(XMLHttpRequest, [{
	    ...
	    value: function abort() {
	      let myRequestTask = _requestTask.get(this);
	    ...
	    value: function getAllResponseHeaders() {
	      let responseHeader = _responseHeader.get(this);
	    ...
	    value: function setRequestHeader(header, value) {
	      let myHeader = _requestHeader.get(this);
    ...
    let WebSocket = function () {
	  ...
	  _createClass(WebSocket, [{
	    ...
	    value: function close(code, reason) {
	      ...
	      let socketTask = _socketTask.get(this);
  ...
  /***/ (function(module, exports) {
	 ...
	 */
    let FileReader = function FileReader() {
